...
pref("extensions.mdnotes.files.zotero.metadata_prefix", "Z-");
pref("extensions.mdnotes.files.zotero.metadata_suffix", "-zotero");
pref("extensions.mdnotes.files.zotero.note_prefix", "ZN-");
pref("extensions.mdnotes.files.zotero.note_suffix", "-zotero-note");
pref("extensions.mdnotes.files.mdnotes.hub_prefix", "MD-");
pref("extensions.mdnotes.files.mdnotes.hub_suffix", "-mdnotes");
pref("extensions.mdnotes.files.mdnotes.standalone_prefix", "S-");
pref("extensions.mdnotes.files.mdnotes.standalone_suffix", "-standalone");
